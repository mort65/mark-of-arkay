Scriptname zzzmoaitemcheckerscriptC extends Quest
...
event OnCheckItemsC(Form akSender, Int aiCount, Form akMyChest, Bool abRemoveAll)
  iNum = aiCount
...
state Checking
  ...
  function removeitems(ObjectReference akInChest, ObjectReference akOutChest, Form[] Tradables, Form[] Equipment, Bool bRemoveAll)
    ...
    while (!bBreak)
      ...
      if bBreak
        Debug.TraceConditional("MarkOfArkay: " + iChecked + " items checked by ItemCheckerC", bIsLoggingEnabled)
      endif
    endwhile
