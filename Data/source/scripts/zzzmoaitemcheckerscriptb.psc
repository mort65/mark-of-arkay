Scriptname zzzmoaitemcheckerscriptB extends Quest
...
event OnCheckItemsB(Form akSender, Int aiCount, Form akMyChest, Bool abRemoveAll)
  iNum = aiCount
...
state Checking
  ...
  function removeitems(ObjectReference akInChest, ObjectReference akOutChest, Form[] Tradables, Form[] Equipment, Bool bRemoveAll)
    ...
    while (!bBreak)
      ...
      if bBreak
        Debug.TraceConditional("MarkOfArkay: " + iChecked + " items checked by ItemCheckerB", bIsLoggingEnabled)
      endif
    endwhile
