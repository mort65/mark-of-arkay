Scriptname zzzmoaitemcheckerscriptD extends Quest  
...
Event OnCheckItemsD(Form akSender, Int aiCount, Form akMyChest, Bool abRemoveAll)
	iNum = aiCount
...
Function removeitems(ObjectReference akInChest, ObjectReference akOutChest, Form[] Tradables, Form[] Equipment, Bool bRemoveAll)
	...
	While (!bBreak )
		...
		EndIf
		If bBreak
			Debug.TraceConditional("MarkOfArkay: "+ iChecked +" items checked by ItemCheckerD",bIsLoggingEnabled)
		EndIf
	Endwhile
