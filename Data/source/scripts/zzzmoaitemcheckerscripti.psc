Scriptname zzzmoaitemcheckerscriptI extends Quest  
...
Event OnCheckItemsI(Form akSender, Int aiCount, Form akMyChest, Bool abRemoveAll)
	iNum = aiCount
...
State Checking
	...
	Function removeitems(ObjectReference akInChest, ObjectReference akOutChest, Form[] Tradables, Form[] Equipment, Bool bRemoveAll)
		...
		While (!bBreak )
			...
			EndIf
			If bBreak
				Debug.TraceConditional("MarkOfArkay: "+ iChecked +" items checked by ItemCheckerI",bIsLoggingEnabled)
			EndIf
		Endwhile
